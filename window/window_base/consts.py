...
CONFIG_PATH = app_dir()/'configs'/'window_base.json'
BACKGROUND_QML_PATH = str(app_dir()/'layout'/'qml'/'background.qml')
WINDOWBASE_QSS_PATH = str(app_dir()/'layout'/'qss'/'window_base.qss')
